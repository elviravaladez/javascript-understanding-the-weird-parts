...
//there are many functions and function prototypes that already exist as function constructors
//ex:
var a = new Number(3);
...
//Creating objects that contain primitives using the syntax above: new String('John')

console.log("John".length);//4

//Anytime you see:
var c = new Date("06/03/2021");
console.log(c);
//Thu Jun 03 2021 00:00:00 GMT-0500 (Central Daylight Time)

//Using built-in function constructors allows us to access other methods such as .indexOf()
String.prototype.isLengthGreaterThan = function (limit) {
    return this.length > limit;
}
//String.prototype is where all string object will look at down the prototype chain
console.log('John'.isLengthGreaterThan(3));//true
//'John' string is converted into an object automatically

//primitive String is automatically converted to String object generated by the String.prototype function
//because a "." was put after it.
//We added a method to the prototype, which gives access to ALL other Strings instantly (cool 😎)
//BUT when you use this type of code:
Number.prototype.isPositive = function() {
    return this > 0;
}
//and use the same method as 'John'.isLengthGreaterThan(3)
// console.log(3.isPositive());
// THIS DOES NOT WORK BECAUSE JS DOES NOT AUTOMATICALLY CONVERT NUMBERS TO OBJECTS
